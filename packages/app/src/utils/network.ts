import { sepolia, mainnet, arbitrum, base, linea, polygon, optimism, scroll } from 'viem/chains'
import { Chain, hardhat } from 'viem/chains'

let chains = [sepolia, mainnet, arbitrum, base, linea, polygon, optimism, scroll] as [Chain, ...Chain[]]
